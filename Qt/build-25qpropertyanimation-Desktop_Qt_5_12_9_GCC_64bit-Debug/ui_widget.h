...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        geometryWidget->setGeometry(QRect(120, 90, 211, 121));
...
"}"));
        ...
        colorWidget->setGeometry(QRect(120, 230, 211, 121));
...
"}"));
        ...
        opacityWidget->setGeometry(QRect(120, 370, 211, 121));
        opacityWidget->setStyleSheet(QString::fromUtf8("QWidget{\n"
"background-color:rgb(114, 159, 207);\n"
"}"));
        widget = new QWidget(Widget);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(540, 70, 181, 291));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        pushButton_3->setText(QApplication::translate("Widget", "\344\270\215\351\200\217\346\230\216\345\272\246\345\212\250\347\224\273", nullptr));
    } // retranslateUi
